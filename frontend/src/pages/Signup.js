...
function SignupForm() {
  ...
  //     const response = await axios.post(`${process.env.REACT_APP_BASE_URL}/user/sendotp`, { email });
...
const emailOTP = async () => {
  ...
  // console.log(email);
  try {
      const res = await axios.post(`${process.env.REACT_APP_BASE_URL}/user/sendotp`,{ email });
